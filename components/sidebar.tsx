        ...
        <aside className="flex h-full flex-col bg-white">
            ...
            <div className="flex flex-1 flex-col gap-4 p-6 overflow-y-auto">
                <nav className="flex flex-col gap-2">
                    ...
                    <Link
                        className={`flex items-center gap-2 rounded-lg px-3 py-2 transition-colors ${isActive("/orders") ? "bg-gray-100 text-gray-900" : "text-gray-500 hover:text-gray-900"
                            }`}
                        href="/orders"
                    >
                    ...
                    <Link
                        className={`flex items-center gap-2 rounded-lg px-3 py-2 transition-colors ${isActive("/inventory") ? "bg-gray-100 text-gray-900" : "text-gray-500 hover:text-gray-900"
                            }`}
                        href="/inventory"
                    >
                    ...
                    <Link
                        className={`flex items-center gap-2 rounded-lg px-3 py-2 transition-colors ${isActive("/floor-plan") ? "bg-gray-100 text-gray-900" : "text-gray-500 hover:text-gray-900"
                            }`}
                        href="/floor-plan"
                    >
